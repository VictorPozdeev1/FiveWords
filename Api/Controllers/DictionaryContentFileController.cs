...
namespace FiveWords.Api.Controllers
{
    ...
    public class DictionaryContentFileController : ControllerBase
    {
        [HttpPost]
        [Authorize]
        public IActionResult AddWordsFromFile(string dictionaryNameEscaped, IEnumerable<WordTranslation> wordsToAdd, [FromServices] IUsersRepository usersRepository, [FromServices] UserDictionariesUserRepositoriesManager userDictionariesRepoManager)
        {
